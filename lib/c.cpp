...
void insertAsFirstElement(Student *&head, Student *&last)
{
    // Question 4(3)
...
void registerRecord(Student *&head, Student *&last)
{
    // Question 4(3)
    if (isEmpty(head))
        insertAsFirstElement(head, last);
    else {
        Student *temp = dataStudent();
        temp->next = NULL;
        last->next = temp;
        last = temp;
    }
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            registerRecord(head, last); // call function registerRecord()
            break;
        case 2:
